...
| `release-probe` | One-off provider and scratch-output release gate |
| `jupyter` | JupyterLab |
...
- Production services deploy a readable Git SHA tag pinned to an immutable
  registry digest; hosts and batch use the same exact reference.
