...
variable "operator_principals" {
  type        = set(string)
  description = "Named users or groups allowed to operate production VMs through IAP and OS Admin Login."
}
...
variable "host_images" {
  ...
  description = "Reviewed immutable host image references for production VMs."
}
