...
- **One image, five workload roles:** scheduler, API server, notebook, feed, and
  job, plus a one-off release migrator from that exact image.
...
config/           provider-neutral ownership and runtime configuration contracts
